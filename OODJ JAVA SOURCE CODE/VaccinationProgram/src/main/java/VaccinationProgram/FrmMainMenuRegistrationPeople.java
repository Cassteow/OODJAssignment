 ...
 * @author eugen
 */
public class FrmMainMenuRegistrationPeople extends javax.swing.JFrame {

    /**
     * Creates new form FrmMainMenuRegistrationPeople
     */
    public FrmMainMenuRegistrationPeople() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMainMenuRegistrationPeople.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMainMenuRegistrationPeople().setVisible(true);
            }
        });
    }
