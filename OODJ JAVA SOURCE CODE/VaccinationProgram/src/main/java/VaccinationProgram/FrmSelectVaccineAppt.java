...
public class FrmSelectVaccineAppt extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmSelectVaccineApptPersonnel
     */
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pfizer ", "Sinovac", "AstraZeneca" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSelectVaccineAppt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
